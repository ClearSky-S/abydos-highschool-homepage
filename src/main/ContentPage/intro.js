...
function Symbol() {
    return (
        <div className="article-style-one">
            ...
            <p>거대한 피라미드 모양의 로고는 과거 이집트를 정신적·문화적으로 계승한 아비도스를 가장 상징적으로 나타낸 조형물입니다. 아비도스 대본관이 위치한 자리는 과거 이집트의 수도 아비도스가 위치했던 자리이기도 합니다. 피라미드의 중앙에는 밝은 빛의 문양은 사막의 꺼지지 않는 태양을 상징합니다. 이는 아비도스의 영원한 영광과 강인한 정신을 나타냅니다.</p>
        </div>
    );
}
